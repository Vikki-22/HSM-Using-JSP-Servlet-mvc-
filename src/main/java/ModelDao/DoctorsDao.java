...
public class DoctorsDao {
	...
	public int addDoctor(Doctors d) {
		...
		try {
			...
			String query = "insert into doctors(first_name,last_name,specialization,phone,email,hire_date,department_id) values(?,?,?,?,?,?,?)";
	...
	public List<Doctors> viewAllDoctors() {
		...
		try {
			...
			while (rs.next()) {
				...
				Doctors d = new Doctors(rs.getInt("doctor_id"), rs.getString("first_name"), rs.getString("last_name"),
	...
	public Doctors viewDoctorById(int id) {
		...
		try {
			...
			if (rs.next()) {
				Departments dept = new Departments();
				dept.setDepartment_id(rs.getInt("department_id"));
				d = new Doctors(rs.getInt("doctor_id"), rs.getString("first_name"), rs.getString("last_name"),
						rs.getString("specialization"), rs.getString("phone"), rs.getString("email"),
						rs.getDate("hire_date"), dept);
			}
	...
	// search doctor
	public List<Doctors> searchDoctorByName(String name) {
		...
		try {
			...
			String query = "select * from doctors where first_name like ? or last_name like ?";
