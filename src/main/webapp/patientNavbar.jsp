		...
		<div class="collapse navbar-collapse" id="doctorNav">
			...
			<ul class="navbar-nav mx-auto">
				...
				<li class="nav-item"><a class="nav-link active-link"
					href="addPatient.jsp"> <i class="bi bi-person-plus-fill"></i>
						Add Patient
				</a></li>

				<!-- VIEW DOCTORS -->
				<li class="nav-item"><a class="nav-link"
					href="<%=request.getContextPath()%>/ViewPatientServlet"> <i
						class="bi bi-people-fill"></i> View Patient
				</a></li>

				<!-- SEARCH DOCTOR -->
				<li class="nav-item">
					<form class="d-flex"
						action="<%=request.getContextPath()%>/SearchPatientServlet"
						method="get">
